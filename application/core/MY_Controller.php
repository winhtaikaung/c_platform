...
class MY_Controller extends CI_Controller{
     ...
     */
    public function renderwindow($contentviewname,$viewdata=array()){
        //Partial Views
        $header='templates/header';
        ...
        $notification='templates/partial_view/success';
        ...
        if(count($viewdata)>0){
            ...
            //makes notification
            $this->load->view($notification,$viewdata);
        }
        else{
            $this->load->view($contentviewname);
     ...
     */
    public function rendertableview($contentviewname,$viewdata=array()){
        $header='templates/header';
        $windowheader='templates/windowheader';
        $windowfooter='templates/windowfooter';
